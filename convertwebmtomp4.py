...
def convert_webm_to_hdr_mp4(input_file, output_file):
    command = f'ffmpeg -i {input_file} -c:v libx264 -vf "hdr=merge=split" -c:a aac {output_file}'
    os.system(command)
...
convert_webm_to_hdr_mp4(input_file, output_file)